...
public class ViewActions {
    ...
    protected static JMenu viewMenu = new JMenu(MessagePrefBundle.getString("MB_VIEW"));
    ...
    public ViewActions() {
        ...
        actions.add(new ZoomInAction(MessagePrefBundle.getString("AB_VIEW_ZOOMIN"), null, MessagePrefBundle.getString("DS_VIEW_ZOOMIN"), Integer.valueOf(KeyEvent.VK_PLUS)));
        actions.add(new ZoomOutAction(MessagePrefBundle.getString("AB_VIEW_ZOOMOUT"), null, MessagePrefBundle.getString("DS_VIEW_ZOOMOUT"), Integer.valueOf(KeyEvent.VK_MINUS)));
        actions.add(new ZoomFullAction(MessagePrefBundle.getString("AB_VIEW_ZOOMFULL"), null, MessagePrefBundle.getString("DS_VIEW_ZOOMFULL"), Integer.valueOf(KeyEvent.VK_1)));
        Toolbar.add(new ZoomInAction(null, new ImageIcon("src/toolbarIcons/ZoomInIcon.png"), MessagePrefBundle.getString("DS_VIEW_ZOOMIN"), Integer.valueOf(KeyEvent.VK_PLUS)));
        Toolbar.add(new ZoomOutAction(null, new ImageIcon("src/toolbarIcons/ZoomOutIcon.png"), MessagePrefBundle.getString("DS_VIEW_ZOOMOUT"), null));
        
        KeyboardListener.add(KeyStroke.getKeyStroke(KeyEvent.VK_EQUALS, InputEvent.CTRL_DOWN_MASK), new ZoomInAction(null, null, null, null));
        KeyboardListener.add(KeyStroke.getKeyStroke(KeyEvent.VK_MINUS, InputEvent.CTRL_DOWN_MASK), new ZoomOutAction(null, null, null, null));        
    }
